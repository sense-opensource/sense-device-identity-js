...
export function x64Add(m: number[], n: number[]) {
    //
...
export function x64Multiply(m: number[], n: number[]) {
    //
    // Given two 64bit ints (as an array of two 32bit ints) returns the two
...
export function x64Rotl(m: number[], n: number) {
    //
...
export function x64LeftShift(m: number[], n: number) {
    //
    // Given a 64bit int (as an array of two 32bit ints) and an int
    // representing a number of bit positions, returns the 64bit int (as an
...
export function x64Xor(m: number[], n: number[]) {
    //
    // Given two 64bit ints (as an array of two 32bit ints) returns the two
...
export function x64Fmix(h: number[]) {
    //
